                ...
                <div class="card-body">
                    <form action="{{ route('user.update', $user->id) }}" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="name_id" class="form-control @error('name') is-invalid @enderror" value="{{ isset($user) ? $user->name : '' }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="email" id="email_id" class="form-control @error('email') is-invalid @enderror" value="{{ isset($user) ? $user->email : '' }}" >
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" pattern="[1-9]{1}[0-9]{9}" name="phone" id="phone_id" class="form-control @error('phone') is-invalid @enderror" value="{{ isset($user) ? $user->phone : '' }}">
                        ...
                        <div class="form-group">
                            ...
                            <div id="image-preview">
                                ...
                                @if($user->profile_img€)
                                    <img src="{{ asset('storage/profile-images/' . $user->profile_img) }}" id="check_profile_img" alt="Profile Image" class="img-fluid" style="width: 100px; height: 100px;">
                                @else
                                    <img src="{{ asset('assets/img/default-user-image.png') }}" alt="Profile Image" class="img-fluid" style="width: 100px; height: 100px;"/>';
                                @endif
                            </div>
...
<script>
    function validateForm() {
        ...
        var profile_img = document.getElementById('check_profile_img').value;
